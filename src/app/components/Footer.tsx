...
const Footer = () => {
  ...
  <div className="container px-5 py-24 mx-auto">
    <div className="flex flex-wrap md:text-left text-center order-first">
      ...
      <div className="lg:w-1/4 md:w-1/2 w-full px-4">
        <h2 className="title-font font-medium font-bold text-gray-900 tracking-widest text-sm mb-3">Links</h2>
      ...
      <div className="lg:w-1/4 md:w-1/2 w-full px-4">
        ...
        <div className="flex xl:flex-nowrap md:flex-nowrap lg:flex-wrap flex-wrap justify-center items-end md:justify-start">
          ...
          <button className="lg:mt-2 xl:mt-0 flex-shrink-0 inline-flex text-black bg-white border border-5 py-2 px-6 focus:outline-none hover:bg-black hover:text-white rounded">Subscribe</button>
        </div>
